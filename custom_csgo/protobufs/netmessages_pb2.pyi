...
class CCLCMsg_ClientMessage(_message.Message):
    ...
    data: bytes
    msg_type: int
    def __init__(self, msg_type: _Optional[int] = ..., data: _Optional[bytes] = ...) -> None: ...
...
class CCLCMsg_Move(_message.Message):
    __slots__ = ["command_number", "data", "num_commands"]
    COMMAND_NUMBER_FIELD_NUMBER: _ClassVar[int]
    DATA_FIELD_NUMBER: _ClassVar[int]
    NUM_COMMANDS_FIELD_NUMBER: _ClassVar[int]
    command_number: int
    data: bytes
    num_commands: int
    def __init__(self, data: _Optional[bytes] = ..., command_number: _Optional[int] = ..., num_commands: _Optional[int] = ...) -> None: ...
...
class CCLCMsg_ServerPing(_message.Message):
    __slots__ = []
...
class CMsgServerNetworkStats(_message.Message):
    __slots__ = ["avg_data_in", "avg_data_out", "avg_latency_in", "avg_latency_out", "avg_loss_in", "avg_loss_out", "avg_packets_in", "avg_packets_out", "cpu_usage", "dedicated", "fps", "memory_free_mb", "memory_used_mb", "num_bots", "num_clients", "num_spectators", "num_tv_relays", "players", "ports", "spawn_count", "total_data_in", "total_data_out", "total_packets_in", "total_packets_out", "uptime"]
    class Player(_message.Message):
        __slots__ = ["is_bot", "packet_loss_pct", "ping_avg_ms", "ping_stddev_ms", "remote_addr", "steamid"]
        IS_BOT_FIELD_NUMBER: _ClassVar[int]
        PACKET_LOSS_PCT_FIELD_NUMBER: _ClassVar[int]
        PING_AVG_MS_FIELD_NUMBER: _ClassVar[int]
        PING_STDDEV_MS_FIELD_NUMBER: _ClassVar[int]
        ...
        remote_addr: str
        steamid: int
        def __init__(self, steamid: _Optional[int] = ..., remote_addr: _Optional[str] = ..., ping_stddev_ms: _Optional[int] = ..., ping_avg_ms: _Optional[int] = ..., packet_loss_pct: _Optional[float] = ..., is_bot: bool = ...) -> None: ...
    ...
    AVG_LATENCY_IN_FIELD_NUMBER: _ClassVar[int]
    AVG_LATENCY_OUT_FIELD_NUMBER: _ClassVar[int]
    ...
    avg_data_in: float
    avg_data_out: float
    avg_latency_in: float
    avg_latency_out: float
    avg_loss_in: float
    avg_loss_out: float
    ...
    uptime: int
    def __init__(self, dedicated: bool = ..., cpu_usage: _Optional[int] = ..., memory_used_mb: _Optional[int] = ..., memory_free_mb: _Optional[int] = ..., uptime: _Optional[int] = ..., spawn_count: _Optional[int] = ..., num_clients: _Optional[int] = ..., num_bots: _Optional[int] = ..., num_spectators: _Optional[int] = ..., num_tv_relays: _Optional[int] = ..., fps: _Optional[float] = ..., ports: _Optional[_Iterable[_Union[CMsgServerNetworkStats.Port, _Mapping]]] = ..., avg_latency_out: _Optional[float] = ..., avg_latency_in: _Optional[float] = ..., avg_packets_out: _Optional[float] = ..., avg_packets_in: _Optional[float] = ..., avg_loss_out: _Optional[float] = ..., avg_loss_in: _Optional[float] = ..., avg_data_out: _Optional[float] = ..., avg_data_in: _Optional[float] = ..., total_data_in: _Optional[int] = ..., total_packets_in: _Optional[int] = ..., total_data_out: _Optional[int] = ..., total_packets_out: _Optional[int] = ..., players: _Optional[_Iterable[_Union[CMsgServerNetworkStats.Player, _Mapping]]] = ...) -> None: ...
...
class CMsgVoiceAudio(_message.Message):
    __slots__ = ["format", "sample_rate", "section_number", "sequence_bytes", "uncompressed_sample_offset", "voice_data"]
    ...
    voice_data: bytes
    def __init__(self, format: _Optional[_Union[VoiceDataFormat_t, str]] = ..., voice_data: _Optional[bytes] = ..., sequence_bytes: _Optional[int] = ..., section_number: _Optional[int] = ..., sample_rate: _Optional[int] = ..., uncompressed_sample_offset: _Optional[int] = ...) -> None: ...
...
class CSVCMsg_ClassInfo(_message.Message):
    ...
    class class_t(_message.Message):
        __slots__ = ["class_id", "class_name", "data_table_name"]
        ...
        class_name: str
        data_table_name: str
        def __init__(self, class_id: _Optional[int] = ..., data_table_name: _Optional[str] = ..., class_name: _Optional[str] = ...) -> None: ...
...
class CSVCMsg_CreateStringTable(_message.Message):
    __slots__ = ["data_compressed", "flags", "name", "num_entries", "string_data", "uncompressed_size", "user_data_fixed_size", "user_data_size", "user_data_size_bits"]
    ...
    def __init__(self, name: _Optional[str] = ..., num_entries: _Optional[int] = ..., user_data_fixed_size: bool = ..., user_data_size: _Optional[int] = ..., user_data_size_bits: _Optional[int] = ..., flags: _Optional[int] = ..., string_data: _Optional[bytes] = ..., uncompressed_size: _Optional[int] = ..., data_compressed: bool = ...) -> None: ...
...
class CSVCMsg_PacketEntities(_message.Message):
    __slots__ = ["active_spawngroup_handle", "alternate_baselines", "baseline", "command_queue_info", "delta_from", "entity_data", "is_delta", "last_cmd_number", "max_entries", "max_spawngroup_creationsequence", "pending_full_frame", "serialized_entities", "server_tick", "update_baseline", "updated_entries"]
    ...
    class command_queue_info_t(_message.Message):
        __slots__ = ["command_queue_desired_size", "commands_queued", "discarded_command_ticks", "starved_command_ticks", "time_dilation_percent"]
        COMMANDS_QUEUED_FIELD_NUMBER: _ClassVar[int]
        COMMAND_QUEUE_DESIRED_SIZE_FIELD_NUMBER: _ClassVar[int]
        DISCARDED_COMMAND_TICKS_FIELD_NUMBER: _ClassVar[int]
        STARVED_COMMAND_TICKS_FIELD_NUMBER: _ClassVar[int]
        TIME_DILATION_PERCENT_FIELD_NUMBER: _ClassVar[int]
        command_queue_desired_size: int
        commands_queued: int
        discarded_command_ticks: int
        starved_command_ticks: int
        time_dilation_percent: float
        def __init__(self, commands_queued: _Optional[int] = ..., command_queue_desired_size: _Optional[int] = ..., starved_command_ticks: _Optional[int] = ..., time_dilation_percent: _Optional[float] = ..., discarded_command_ticks: _Optional[int] = ...) -> None: ...
    ...
    baseline: int
    command_queue_info: CSVCMsg_PacketEntities.command_queue_info_t
    delta_from: int
    entity_data: bytes
    is_delta: bool
    last_cmd_number: int
    ...
    updated_entries: int
    def __init__(self, max_entries: _Optional[int] = ..., updated_entries: _Optional[int] = ..., is_delta: bool = ..., update_baseline: bool = ..., baseline: _Optional[int] = ..., delta_from: _Optional[int] = ..., entity_data: _Optional[bytes] = ..., pending_full_frame: bool = ..., active_spawngroup_handle: _Optional[int] = ..., max_spawngroup_creationsequence: _Optional[int] = ..., last_cmd_number: _Optional[int] = ..., server_tick: _Optional[int] = ..., serialized_entities: _Optional[bytes] = ..., command_queue_info: _Optional[_Union[CSVCMsg_PacketEntities.command_queue_info_t, _Mapping]] = ..., alternate_baselines: _Optional[_Iterable[_Union[CSVCMsg_PacketEntities.alternate_baseline_t, _Mapping]]] = ...) -> None: ...
...
class CSVCMsg_VoiceData(_message.Message):
    __slots__ = ["audible_mask", "audio", "client", "proximity", "tick", "xuid"]
    ...
    tick: int
    xuid: int
    def __init__(self, audio: _Optional[_Union[CMsgVoiceAudio, _Mapping]] = ..., client: _Optional[int] = ..., proximity: bool = ..., xuid: _Optional[int] = ..., audible_mask: _Optional[int] = ..., tick: _Optional[int] = ...) -> None: ...
...
class ProtoFlattenedSerializerField_t(_message.Message):
    __slots__ = ["bit_count", "encode_flags", "field_serializer_name_sym", "field_serializer_version", "high_value", "low_value", "send_node_sym", "var_encoder_sym", "var_name_sym", "var_type_sym"]
