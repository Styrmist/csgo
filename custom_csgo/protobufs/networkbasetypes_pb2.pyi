...
class CNETMsg_Disconnect(_message.Message):
    ...
    reason: _network_connection_pb2.ENetworkDisconnectionReason
    def __init__(self, reason: _Optional[_Union[_network_connection_pb2.ENetworkDisconnectionReason, str]] = ...) -> None: ...
...
class CNETMsg_Tick(_message.Message):
    __slots__ = ["hltv_replay_flags", "host_computationtime", "host_computationtime_std_deviation", "host_framestarttime_std_deviation", "host_frametime", "host_frametime_std_deviation", "host_loss", "host_unfiltered_frametime", "tick"]
    ...
    tick: int
    def __init__(self, tick: _Optional[int] = ..., host_frametime: _Optional[int] = ..., host_frametime_std_deviation: _Optional[int] = ..., host_computationtime: _Optional[int] = ..., host_computationtime_std_deviation: _Optional[int] = ..., host_framestarttime_std_deviation: _Optional[int] = ..., host_loss: _Optional[int] = ..., host_unfiltered_frametime: _Optional[int] = ..., hltv_replay_flags: _Optional[int] = ...) -> None: ...
